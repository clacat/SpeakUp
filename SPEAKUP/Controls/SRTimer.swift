...
//  SpeakAppOne
//
//  Created by Alexey Antonov on 22.11.2019.
//  Copyright © 2019 Alexey Antonov. All rights reserved.
//
...
public class SRCountdownTimer: UIView {
    ...
    @IBInspectable public var trailLineColor: UIColor = UIColor.yellow.withAlphaComponent(0.0)
